...
The other day, whilst working on a [complex application](https://pictoforge.mediafranca.net), I was conversing colloquially with my AI coding assistant in Spanish to solve a problem. In that moment, I paused. If you had described this scene to my younger self 20 or 30 years ago, it would have seemed utterly implausible, pure science fiction. This feeling is captured perfectly by a concept from Tim Urban’s ‘[Wait But Why](https://waitbutwhy.com/)’: the Die Progress Unit (DPU). A DPU is the amount of technological progress that would overwhelm a person from a past era to the point of shock, or even death, if they were transported to the future. A chap from the 1750s brought to our time would almost certainly experience a DPU.

The reason this progress feels so jarringly fast is explained by what futurist Ray Kurzweil calls the [Law of Accelerating Returns](https://www.writingsbyraykurzweil.com/the-law-of-accelerating-returns). The principle is simple: more advanced societies progress faster than less advanced ones because they have better tools with which to innovate. After all, inventions tend to compound over each other. We often make the mistake of thinking about progress linearly, looking at the last 30 years to predict the next 30. But we should be thinking exponentially. This law explains why the present feels so profoundly futuristic compared to the very recent past, and why we are living through a DPU right now.

This is where the metaphor of the "centaur" becomes so powerful. In this new reality, AI doesn't replace us; it extends our natural capabilities, allowing us to think and create at an incredible speed((I think this [this video](https://youtu.be/ClH41qQaR0U?si=K_lS9lbuctgZSguC) captures the spirit.)). We are the human torso, providing the vision and direction, while the AI is the powerful equine body, executing complex tasks at a pace we could never achieve alone.

My current project, [PictoForge](https://github.com/hspencer/pictoforge), is a kind of human-side counterpart to a generative model that creates pictograms from the communicative intent of people who use text to express themselves (PictoNet), including those with complex communication needs. Where the model proposes pictograms, PictoForge allows me to manipulate, refine, and audit that output, checking pragmatically whether the image actually supports the intended act of communication, and documenting the whole process in a clear, structured way. A few years ago, building such a tool would have been unthinkable for me; today, with my AI partner, I am developing it mainly on my own, in the absence of human collaborators willing to enter this niche, as part of what is, after all, a doctoral project that everyone insists is a solitary journey. So, I could state that AI is the great equaliser, turning vision into reality without the traditional barriers.
...
Recent research((Cotroneo, D., Improta, C., & Liguori, P. (2025). Human-Written vs. AI-Generated Code: A Large-Scale Study of Defects, Vulnerabilities, and Complexity (No. arXiv:2508.21634). arXiv. https://doi.org/10.48550/arXiv.2508.21634)) helps explain the technical profile of this code. A study from arXiv, "Human-Written vs. AI-Generated Code", reveals why vibe-coded projects might be tricky to maintain. And this rings true for me; I've noticed my AI partner sometimes produces code that works perfectly but contains odd leftovers, like a beautifully constructed cabinet with some sawdust still in the corners. The research found that:
...
This brings me back to the idea that this golden era of human-AI partnership might be a *brevísimo instante*—a very brief moment. The 'Wait But Why'((In [this rather old post from 2015](https://waitbutwhy.com/2015/01/artificial-intelligence-revolution-2.html) the joke of how fast would the ascent of AI will be, poses the idea that this collaborative state migh be a very brief moment.)) articles introduce the concept of a "tripwire". This isn't a physical wire but a metaphorical one, representing the moment AI could achieve Artificial General Intelligence (AGI) or even Artificial Superintelligence (ASI). Hitting that tripwire would trigger a world-altering "intelligence explosion".

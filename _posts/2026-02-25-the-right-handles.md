...
sidebar:
  html: |
    <div style="font-size: 70%; line-height: 1.4; margin-top: 1.5em;">
    <p style="font-weight: bold; margin-bottom: 0.5em;">SVG Metadata</p>
    <table style="width: 100%; border-collapse: collapse; font-size: 90%;">
    <tr><td style="padding: 2px 4px; color: #888;">utterance</td></tr>
    <tr><td style="padding: 2px 4px;"><em>let's see together the magnificent spectacle of language</em></td></tr>
    <tr><td style="padding: 2px 4px; color: #888; padding-top: 8px;">NSM primes</td></tr>
    <tr><td style="padding: 2px 4px;">PEOPLE · SAY · SOMETHING · HEAR</td></tr>
    <tr><td style="padding: 2px 4px; color: #888; padding-top: 8px;">concepts</td></tr>
    <tr><td style="padding: 2px 4px;">observers group · language spectacle · central glyph · symbol burst · alpha char · omega char · punctuation marks · radiant waves</td></tr>
    <tr><td style="padding: 2px 4px; color: #888; padding-top: 8px;">implicit action</td></tr>
    <tr><td style="padding: 2px 4px;">Observing / Gazing forward</td></tr>
    <tr><td style="padding: 2px 4px; color: #888; padding-top: 8px;">provenance</td></tr>
    <tr><td style="padding: 2px 4px;">PictoNet v2.7 · 2026-02-25<br/>CC BY 4.0</td></tr>
    </table>
    </div>
---
...
The code is on [GitHub](https://github.com/hspencer/pictos-net). The work continues.

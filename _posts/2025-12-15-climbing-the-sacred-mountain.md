...
description: "On practice-led doctoral research, the productive tension between making and framing, and why the format itself is a form of integrity."
date: 2025-12-14
categories:
- ideas
- academia
...
#### From Valparaiso to Tamaki Makaurau

I am undertaking a practice-led doctorate((**Format 1** is the conventional research doctorate. Knowledge is produced primarily through analytical argumentation, empirical data, and theoretical synthesis, and is presented as a single, extended written thesis. Practice may inform the research, but it is not itself the primary site of knowledge production. <br>**Format 2** is practice-informed. Creative or professional practice plays an important role in shaping the inquiry, but the main contribution to knowledge is still articulated through a substantial written thesis. Practice supports the research rather than constituting it. <br>**Format 3**, which I am undertaking, is practice-oriented (often called practice-led or practice-based). Here, practice is not illustrative or auxiliary; it is the central means through which knowledge is generated. Artefacts, systems, prototypes, performances, or designed interventions are treated as epistemic objects. The written component, the exegesis, does not replace the practice, nor does it attempt to fully translate it into text. Instead, it situates, reflects on, and critically articulates what the practice produces as knowledge. <br>This format is particularly relevant for architecture, design, and the arts, where understanding often emerges through making, iteration, encounter, and failure. In this sense, Format 3 formalises something many of us have already been doing for years: treating practice as a legitimate form of inquiry rather than as a prelude to real research. <br>This format does not yet exist in Chile in any formal sense. Its institutional recognition was a decisive reason for undertaking my doctorate in Aotearoa New Zealand.)) at Auckland University of Technology (AUT), in Aotearoa New Zealand.
...
[Paul Feyerabend](https://en.wikipedia.org/wiki/Paul_Feyerabend) argued against the idea of a single privileged method, insisting that rigid methodological rules often misdescribe how knowledge is actually produced, and that plurality is not a defect but a condition of discovery((Paul Feyerabend, *Against Method* (1975; later editions).)). [Donna Haraway](https://campusdirectory.ucsc.edu/cd_detail?uid=haraway) proposed "situated knowledges"((Donna Haraway, "Situated Knowledges: The Science Question in Feminism and the Privilege of Partial Perspective" (1988).)), the idea that claims become more accountable when their position, limits, and relations are stated rather than hidden behind a universal voice. [Boaventura de Sousa Santos](https://www.boaventurasantos.com/) argues for cognitive justice((Boaventura de Sousa Santos, *Epistemologies of the South* (various essays).)): that there can be no social justice without plurality in what counts as knowledge. [Gloria Anzaldua](https://es.wikipedia.org/wiki/Gloria_Anzald%C3%BAa) wrote from the borderlands and treated hybrid writing as a legitimate way of doing theory((Gloria Anzaldua, *Borderlands/La Frontera: The New Mestiza* (1987).)). [Arturo Escobar](https://anthropology.unc.edu/people/arturo-escobar/)'s idea of the pluriverse, "a world where many worlds fit", extends this logic to design((Arturo Escobar, *Designs for the Pluriverse* (2018).)). [Catherine Walsh](https://racespaceplace.com/people-draft/catherine-walsh/) argues for interculturality as an epistemic project((Catherine Walsh, essays on interculturality and decoloniality (mid-2000s onwards).)). Closer to my immediate context, Welby Ings writes about *invisible intelligence*: forms of intelligence that institutions often recognise only after they have already failed the people who carried them((Welby Ings, [Invisible Intelligence](https://e-tangata.co.nz/reflections/invisible-intelligence/), e-tangata)).
...
I am learning to frame my work in a narrower, examinable way, and I am grateful for the discipline this imposes. The [refined version of my doctoral proposal](/2026/the-right-handles) is tighter, more focused, and more honest about what it can and cannot do. That tightening was not a concession; it was a clarification. The project is better for it. And I am better for having been forced to earn the compression rather than assume it.
